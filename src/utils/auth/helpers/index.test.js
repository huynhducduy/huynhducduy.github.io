...
it("set and get product", () => {
    const some_number = 1;
    helpers.setProduct(some_number);
    expect(helpers.getProductCode()).toEqual(some_number);
});
...
it("clear authentication data", () => {
    ...
    helpers.setProduct(some_string);
    ...
    expect(helpers.getProductCode()).toEqual(0);
});
